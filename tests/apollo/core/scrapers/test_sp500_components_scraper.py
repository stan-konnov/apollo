...
from apollo.core.scrapers.sp500_components_scraper import SP500ComponentsScraper


@patch(
    "apollo.core.scrapers.sp500_components_scraper.SP500_COMPONENTS_URL",
...
@pytest.mark.parametrize(
    "requests_get_call",
    ["apollo.core.scrapers.sp500_components_scraper.get"],
    indirect=True,
)
